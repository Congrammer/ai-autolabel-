...
def findvideo():    
    ...
    download_path = os.path.join(script_dir, "download1")
...
def videoTOframe():
    ...
    videos_folder = os.path.join(script_dir, "download1")
    # set the desired frame rate for the extracted frames
    fps = 600
    # create a folder to save the extracted frames
    frames_folder_name=os.path.join(script_dir, "frames_extracted1")
...
def verificaimg():
    ...
    input_folder = os.path.join(script_dir, "frames_extracted1")
